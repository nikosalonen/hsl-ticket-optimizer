...
export const fi: TranslationMap = {
  ...
  "results.best": "Paras",
  "results.moreExpensivePerMonth": "+{amount} \u20AC/kk kalliimpi kuin halvin",
  ...
  "results.perYear": "/v",
  "results.moreExpensivePerYear": "+{amount} \u20AC/v kalliimpi kuin halvin",
  ...
  "ticket.season.description": "30 päivän lippu",
